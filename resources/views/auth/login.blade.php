<x-layouts.guest-layout>
    <div
         class="mx-auto flex max-w-lg rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-8">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4 mt-2 flex justify-center italic">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    <x-form.text-input id="password" name="password" type="password" autocomplete="current-password" />
                    <span class="absolute right-4 top-4">
